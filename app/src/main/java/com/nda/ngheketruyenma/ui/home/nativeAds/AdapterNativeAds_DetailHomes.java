package com.nda.ngheketruyenma.ui.home.nativeAds;
...
public class AdapterNativeAds_DetailHomes extends RecyclerView.Adapter<AdapterWithNativeAd.BaseViewHolder>{
    ...
    public AdapterNativeAds_DetailHomes(@NonNull Context context) {
    ...
    @NonNull
    @Override
    public AdapterWithNativeAd.BaseViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == TYPE_NATIVE_AD) {
            View view = LayoutInflater.from(context).inflate(R.layout.native_ad_item, parent, false);
            return new AdapterNativeAds_DetailHomes.NativeAdHolder(view);
        } else if (viewType == TYPE_DATA) {
            return new AdapterWithNativeAd.DataViewHolder(new TextView(context));
        } else {
            // NOTE this case is impossible
            return new AdapterWithNativeAd.BaseViewHolder(new View(context));
        }
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterWithNativeAd.BaseViewHolder holder, int position) {
    ...
    static class NativeAdHolder extends AdapterWithNativeAd.BaseViewHolder {
        ImageView icon;
        TextView title;
    ...
    static class DataViewHolder extends AdapterWithNativeAd.BaseViewHolder {
